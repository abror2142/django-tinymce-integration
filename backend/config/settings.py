...
DEBUG = config('DEBUG', default=True) # considering you use it in dev mode

ALLOWED_HOSTS = config('ALLOWED_HOSTS', cast=lambda v: [s.strip() for s in v.split(',')] if v else [], default=[])
